...
class Drag {
  ...
  Drag(this.object, {namespace = 'drag', int delay = 200}) {
    object.addAction<MouseEvent>((e) {
      final timer = new Timer(new Duration(milliseconds: delay), () => drag(e));
      late StreamSubscription document_up;
  ...
  void drag(MouseEvent e) {
    ...
    rect = new math.MutableRectangle(_init_rect!.left, _init_rect!.top,
        _init_rect!.width, _init_rect!.height);
    if (bound != null) {
