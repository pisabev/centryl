...
Future<void> main() async {
  test('XLS', () async {
    final dc =
        new XLS.fromXLSBytes(new File('test/test.xls').readAsBytesSync());
  ...
  test('XLS To .xls', () async {
    ...
    final Stream<List<int>> f = dc.toXls();
    await new File('test/output.xls').openWrite().addStream(f);
  });
}
