(function () {
    ...
    d.makeChart = function (a, b, c) {
        var e = b.type, f = b.theme;
        d.isString(f) && (f = d.themes[f], b.theme =
            f);
        var g;
        switch (e) {
            case "serial":
...
(function () {
    ...
    d.formatDuration = function (a, b, c, e, f, g) {
        var h = d.intervals, k = g.decimalSeparator;
        if (a >= h[b].contains) {
    ...
    d.toScientific = function (a, b) {
        ...
        var c = Math.floor(Math.log(Math.abs(a)) *
            Math.LOG10E), e = String(e).split(".").join(b);
        return String(e) + "e" + c
    };
    ...
    d.hitTest = function (a, b, c) {
        var e = !1, f = a.x, g = a.x + a.width, h = a.y, k = a.y + a.height, l = d.isInRectangle;
        e || (e = l(f, h, b));
        e || (e = l(f, k, b));
        e || (e = l(g, h, b));
        e || (e = l(g, k, b));
    ...
    d.processObject = function (a, b, c, e) {
        if (!1 === a instanceof b && (a = e ? d.extend(new b(c), a) : d.extend(a, new b(c), !0), a.listeners)) for (var f in a.listeners) b =
            a.listeners[f], a.addListener(b.event, b.method);
        return a
    };
    ...
    d.deleteObject = function (a, b) {
        if (a) {
            ...
            if (0 !== b) if ("[object Array]" === Object.prototype.toString.call(a)) for (var c = 0; c < a.length; c++) d.deleteObject(a[c], b - 1), a[c] = null; else if (a && !a.tagName) try {
                for (c in a.theme =
                    null, a) a[c] && ("object" == typeof a[c] && d.deleteObject(a[c], b - 1), "function" != typeof a[c] && (a[c] = null))
            } catch (e) {
            }
        }
    };
    ...
    d.parseDefs = function (a, b) {
        for (var c in a) {
            var e = typeof a[c];
            if (0 < a[c].length && "object" == e) for (var f = 0; f < a[c].length; f++) e = document.createElementNS(d.SVG_NS,
                c), b.appendChild(e), d.parseDefs(a[c][f], e); else "object" == e ? (e = document.createElementNS(d.SVG_NS, c), b.appendChild(e), d.parseDefs(a[c], e)) : b.setAttribute(c, a[c])
        }
    }
})();
(function () {
    ...
    d.AmDraw = d.Class({
        construct: function (a, b, c, e) {
            ...
            d.VML && (f = Math.round(100 * f / Math.min(c, e)), c += 2 * g, e += 2 * g, k.bw = g, k.node.style.marginLeft =
                -g, k.node.style.marginTop = -g);
            1 > c && (c = 1);
            1 > e && (e = 1);
            k.attr({x: a, y: b, width: c, height: e, rx: f, ry: f, "stroke-width": g});
            this.addToContainer(k.node, h);
            return k
        }, image: function (a, b, c, e, f, g) {
            var h = new d.AmDObject("image", this);
            h.attr({x: b, y: c, width: e, height: f});
            this.R.path(h, a);
...
(function () {
    ...
    d.SVGRenderer = d.Class({
        construct: function (a) {
            ...
            c = {obj: a, frame: 0, attribute: b, from: g, to: c, time: e, effect: f};
        ...
        move: function (a, b, c, e) {
            ...
            var g = a.patternNode;
            g && this.D.remove(g);
            var g = document.createElementNS(d.SVG_NS, "pattern"), h = d.getUniqueId(), k = b;
            b.url && (k = b.url);
    ...
    d.AmChart = d.Class({
        construct: function (a) {
            ...
            if (d.ifArray(b)) {
                ...
                for (e = 0; e < b.length; e++) {
                    var f = b[e], f = d.processObject(f, d.Title, this.theme);
                    if (!1 !== f.enabled) {
                        var g =
                            f.color;
            ...
            if (b = "object" != typeof a ? document.getElementById(a) : a) {
                ...
                a = this.chartDiv;
                var c = this.legendDiv, e = this.legend, f = c.style, g = a.style;
                this.measure();
            ...
            var a = this.div;
            if (a) {
                var b = this.chartDiv, c = a.offsetWidth, e = a.offsetHeight, f = this.container;
        ...
        drawLabel: function (a) {
            ...
            if (b.container && !1 !== a.enabled) {
                ...
                var c = a.y, e = a.text, f = a.align, g = a.size, h = a.color, k = a.rotation, l = a.alpha, m = a.bold,
            ...
            a = {x: a, y: b, text: c, align: e, size: d, color: g, alpha: k, rotation: h, bold: l, url: m, enabled: !0};
        ...
        clearLabels: function () {
            ...
            if (c) {
                ...
                c.ieW && (d = c.ieW);
                var g =
                    e.offsetHeight, e = e.style, h = this.chartDiv.style, k = c.position;
        ...
        animate: function (a, b, c, e, f, g, h) {
            a["an_" + b] && d.removeFromArray(this.animations, a["an_" + b]);
            c = {obj: a, frame: 0, attribute: b, from: c, to: e, time: f, effect: g, suffix: h};
            a["an_" + b] = c;
            this.animations.push(c);
            return c
            ...
            if (this.animations) for (a = this.animations.length - 1; 0 <= a; a--) {
                var b = this.animations[a], c = d.updateRate * b.time,
                    e = b.frame + 1, f = b.obj, g = b.attribute;
                if (e <= c) {
                    b.frame++;
            ...
            if (!this.hideCredits) {
                ...
                if (c != a || !0 === this.inIframe()) {
                    var a = "http://www." + a, e = c = 0, d = this.realWidth, g = this.realHeight, h = this.type;
...
(function () {
    ...
    d.AmBalloon = d.Class({
        construct: function (a) {
            ...
            if (!isNaN(a)) {
                var e =
                    this.follow, f = c.container, g = this.set;
                d.remove(g);
                this.removeDiv();
                g = f.set();
                g.node.style.pointerEvents = "none";
                ...
                if (this.show) {
                    var h = this.l, k = this.t, l = this.r, m = this.b, n = this.balloonColor, p = this.fillColor,
                    ...
                    var q = this.horizontalPadding, y = this.verticalPadding, B = this.pointerWidth,
                        u = this.pointerOrientation, w = this.cornerRadius,
                        v = c.fontFamily, A = this.fontSize;
                    ...
                    x < h && (x = h);
                    x + z > l && (x = l - z);
                    var k = A + y, m = x + q, G = this.shadowAlpha, D = this.shadowColor, q = this.borderThickness,
                        K = this.bulletSize, J, y = this.fillAlpha, L = this.borderAlpha;
                    this.showBullet && (J = d.circle(f, K, t, y), g.push(J));
                    this.drop ? (h = z / 1.6, l = 0, "V" == u && (u = "down"), "H" == u && (u = "left"), "down" == u && (x = a + 1, A = b - h - h / 3), "up" == u && (l = 180, x = a + 1, A = b + h + h / 3), "left" == u && (l = 270, x = a + h + h / 3 + 2, A = b), "right" == u && (l = 90, x = a - h - h / 3 + 2, A = b), k = A - E / 2 + 1, m = x - F / 2 - 1, p = d.drop(f, h, l, p, y, q, r, L)) : 0 < w || 0 === B ? (0 < G && (a = d.rect(f,
                    ...
                    0 < this.animationDuration && !e && !isNaN(this.prevX) && (g.translate(this.prevX, this.prevY, NaN, !0), g.animate({translate: x - f + "," + A}, b, "easeOutSine"), n && (C.left = this.prevTX + "px", C.top = this.prevTY + "px", this.xAnim = c.animate({node: n}, "left", this.prevTX,
                        m, b, "easeOutSine", "px"), this.yAnim = c.animate({node: n}, "top", this.prevTY, k, b, "easeOutSine", "px")));
                    this.prevX = x - f;
                    this.prevY = A;
                    this.prevTX = m;
                    this.prevTY = k
...
(function () {
    ...
    d.circle = function (a, b, c, e, f, g, h, k, l) {
        ...
        void 0 === g && (g = "#000000");
        void 0 === h && (h = 0);
        e = {fill: c, stroke: g, "fill-opacity": e, "stroke-width": f, "stroke-opacity": h};
    ...
    d.text = function (a, b, c, e, f, g, h, k) {
        ...
        c = {fill: c, "font-family": e, "font-size": f + "px", opacity: k};
    ...
    d.polygon = function (a, b, c, e, f, g, h, k, l, m, n) {
        ...
        void 0 === h && (h = p);
        f = {fill: p, stroke: h, "fill-opacity": f, "stroke-width": g, "stroke-opacity": k};
    ...
    d.rect = function (a, b, c, e, f, g, h, k, l, m, n) {
        ...
        t += d.dx;
        q += d.dy;
        f = {fill: p, stroke: h, "fill-opacity": f, "stroke-opacity": k};
        void 0 !== n && 0 < n && (f["stroke-dasharray"] = n);
    ...
    d.bullet = function (a, b, c, e, f, g, h, k, l, m, n, p, r) {
        ...
        switch (b) {
            case "round":
                ...
                break;
            case "square":
                t = d.polygon(a, [-c / 2, c / 2, c / 2, -c / 2], [c / 2, c / 2, -c / 2, -c / 2], e, f, g, h,
                    k, m - 180, void 0, r);
                break;
            case "rectangle":
    ...
    d.triangle = function (a, b, c, e, d, g, h, k) {
        ...
        void 0 === k && (k = 0);
        e = {
            fill: e, stroke: h, "fill-opacity": d,
            "stroke-width": g, "stroke-opacity": k
        };
        b /= 2;
        var l;
    ...
    d.makeHD = function (a, b, c) {
        for (var e = [], d = [], g = 1; g < a.length; g++) for (var h = Number(a[g - 1]), k = Number(b[g - 1]), l = Number(a[g]), m = Number(b[g]), n = Math.round(Math.sqrt(Math.pow(l -
    ...
    d.handDrawnLine = function (a, b, c, e, f, g, h, k, l, m) {
        var n, p = a.set();
        for (n = 1; n < b.length; n++) for (var r = [b[n - 1], b[n]], t = [c[n - 1], c[n]], t = d.makeHD(r, t, a.handDrawScatter), r = t[0], t = t[1], q = 1; q < r.length; q++) p.push(d.line(a, [r[q - 1], r[q]], [t[q - 1], t[q]], e, f, g + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, h, k, l, m, !0));
        return p
    };
    ...
    d.drop =
        function (a, b, c, e, d, g, h, k) {
            ...
            90 == c && (y = 0);
            270 == c && (y = 0, B = -B);
            c = {fill: e, stroke: h, "stroke-width": g, "stroke-opacity": k, "fill-opacity": d};
    ...
    /k.wedge(c, A, B, n, r, m, d, f, this.depth3D, p, this.gradientRatio, e.pattern, this.path, this.gradientType)
    d.wedge = function (a, b, c, e, f, g, h, k, l, m, n, p, r, t) {
        var q = Math.round;
        g = q(g);
        h = q(h);
        k = q(k);
        var y = q(h / g * k), B = d.VML, u = 359.5 + g / 100;
        359.94 < u && (u = 359.94);
        f >= u && (f = u);
        var w = 1 / 180 * Math.PI,
            u = b + Math.sin(e * w) * k,
            ...
            E = {fill: d.adjustLuminosity(m.fill, -.2), "stroke-opacity": 0, "fill-opacity": m["fill-opacity"]}, H = 0;
        180 < Math.abs(f) && (H = 1);
        e = a.set();
        var G;
        B && (u = q(10 * u),
        ...
        if (0 < l) {
            D = " M" + u + "," + (v + l) + " L" + A + "," + (C + l);
            B ? (G || (D += " A" + (b - g) + "," + (l + c - h) + "," + (b + g) + "," + (l + c + h) + "," + A + "," + (C + l) + "," + x + "," + (z + l)), D += " L" + F + "," + (w + l), 0 < k && (G || (D += " B" + (b - k) + "," + (l + c - y) + "," + (b + k) + "," + (l + c + y) + "," + F + "," + (l + w) +
                "," + u + "," + (l + v)))) : (D += " A" + g + "," + h + ",0," + H + ",1," + x + "," + (z + l) + " L" + F + "," + (w + l), 0 < k && (D += " A" + k + "," + y + ",0," + H + ",0," + u + "," + (v + l)));
            D += " Z";
            var K = l;
            B && (K /= 10);
...
(function () {
    ...
    d.AmLegend = d.Class({
        construct: function (a) {
            ...
            var a = this.chart, b = this.position, c = this.width, e = a.divRealWidth, f = a.divRealHeight,
                g = this.div, h = this.legendData;
            ...
            var a = this.position, b = this.marginLeft +
                this.titleWidth, c = this.marginRight, e = this.marginTop, f = this.marginBottom,
                g = this.horizontalGap, h = this.div, k = this.divWidth, l = this.maxColumnsReal, m = this.verticalGap,
                n = this.spacing, p = k - c - b, r = 0, t = 0, q = this.container;
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (e) {
                    e = a.type;
                    b.switchType = void 0;
                    if ("line" == e || "step" == e || "smoothedLine" == e || "ohlc" == e) m = p.set(), a.hidden || (g = a.lineColorR, k = a.bulletBorderColorR), t = d.line(p, [0, 2 *
                    r], [r / 2, r / 2], g, a.lineAlpha, a.lineThickness, a.dashLength), d.setCN(c, t, "graph-stroke"), m.push(t), a.bullet && (a.hidden || (g = a.bulletColorR), t = d.bullet(p, a.bullet, a.bulletSize, g, a.bulletAlpha, a.bulletBorderThickness, k, a.bulletBorderAlpha)) && (d.setCN(c, t, "graph-bullet"), t.translate(r + 1, r / 2), m.push(t)), y = 0, t = r, q = r / 3; else {
                        a.getGradRotation && (m = a.getGradRotation(), 0 === m && (m = 180));
                        t = a.fillColorsR;
                        !0 === a.hidden && (t = g);
                        if (m = b.createMarker("rectangle", t, a.fillAlphas, a.lineThickness, g, a.lineAlpha, m, l, a.dashLength)) y =
                            r, m.translate(y, r / 2);
                        t = r
                    }
                    d.setCN(c, m, "graph-" + e);
                ...
                k = b.switchType;
                var u;
                k && "none" != k && 0 < r && ("x" == k ? (u = b.createX(),
                    u.translate(r / 2, r / 2)) : u = b.createV(), u.dItem = a, !0 !== a.hidden ? "x" == k ? u.hide() : u.show() : "x" != k && u.hide(), b.switchable || u.hide(), b.addListeners(u, a), a.legendSwitch = u, p.push(u), d.setCN(c, u, "legend-switch"));
                k = b.color;
                ...
                g = d.massReplace(b.labelText, {"[[title]]": a.title});
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (b.valueText && 0 < b.valueWidth) {
                    ...
                    var k = b.valueText, f = f + b.lx + b.labelDx + b.markerLabelGap +
                        b.valueWidth, l = "end";
            ...
            if (a) for (c = 0; c < a.length; c++) {
                ...
                if (e) g.value ? f.text(g.value) : f.text(""); else {
                    var k = null;
                    if (void 0 !== g.type) {
                        var k = g.currentDataItem, l = this.periodValueText;
                        g.legendPeriodValueText &&
                        (l = g.legendPeriodValueText);
                        g.legendPeriodValueTextR && (l = g.legendPeriodValueTextR);
                        k ? (h = this.valueText, g.legendValueText && (h = g.legendValueText), g.legendValueTextR && (h = g.legendValueTextR), h = b.formatString(h, k)) : l && b.formatPeriodString && (l = d.massReplace(l, {"[[title]]": g.title}), h = b.formatPeriodString(l, g))
                    ...
                    k ? n = b.getBalloonColor(g,
                        k) : g.legendKeyColor && (n = g.legendKeyColor());
...
(function () {
    ...
    d.AmMap = d.Class({
        ...
        animateMap: function () {
            ...
            for (c = 0; c < b.length; c++) {
                var d = b[c].image, f = b[c].scale, g = b[c].mapImage;
            ...
            if (!a || !a.touches || !b.tapToActivate || b.tapped) {
                ...
                var c = b.previuosMouseX, e = b.previuosMouseY, f = b.mouseX, g = b.mouseY, h = b.zoomControl;
                isNaN(c) && (c = f);
                isNaN(e) && (e = g);
                b.mouse2X = NaN;
                b.mouse2Y = NaN;
                ...
                if (a = b.mapContainer) {
                    ...
                    if (!isNaN(k)) {
                        b.stopDrag();
                        var t = Math.sqrt(Math.pow(k - f, 2) + Math.pow(l - g, 2)), q = b.initialDistance;
                        isNaN(q) && (q = Math.sqrt(Math.pow(k - f, 2) + Math.pow(l - g, 2)));
                        if (!isNaN(q)) {
                            var k = b.initialTouchZoom * t / q, k = d.fitToBounds(k, h.minZoomLevel, h.maxZoomLevel),
                                h = b.zoomLevel(), q = b.middleXP, l = b.middleYP, t = m / r, y = n / p,
                                q = (b.zoomX() - q * y) * (k / h) + q * y, l = (b.zoomY() -
                                l * t) * (k / h) + l * t;
        ...
        returnInitialColorReal: function (a) {
            ...
            if (b) {
                ...
                var e = a.alphaReal, f = a.outlineAlphaReal, g = a.outlineThicknessReal, h = a.outlineColorReal;
                if (a.showAsSelected) {
            ...
            var f = this.realWidth, g = this.realHeight,
                h = this.mapSet.scale, k = this.zoomControl,
            ...
            var f = this.dataProvider, g = this.zoomControl, h = Math.abs(c - a), k = Math.abs(b - e),
                l = Math.abs(f.rightLongitude - f.leftLongitude), f = Math.abs(f.topLatitude - f.bottomLatitude),
            ...
            if (!this.objectWasClicked) {
                ...
                var f = this.zoomLevel(), g = this.mapSet.getBBox();
            ...
            if (a) {
                ...
                var e = a.zoomLevel, f = this.zoomInstantly, g = a.zoomX, h = a.zoomY, k = this.realWidth,
                    l = this.realHeight;
            ...
            for (e = 0; e < a.length; e++) {
                ...
                k.path = g;
                this.svgAreasById[f.id] = {area: k, title: h, className: f["class"]};
            ...
            void 0 == f && (f = "");
            var g = b.value, g = isNaN(g) ? "" : d.formatNumber(g, c), c = b.percents,
            ...
            if (c.chartCreated && !c.preventHover && c.checkTouchDuration(b) && !c.mapWasDragged && c.checkIfClickable(a) && !c.mapWasPinched) {
                c.selectObject(a);
                var d = c.zoomLevel(), f = c.mapSet.getBBox(),
        ...
        checkIfClickable: function (a) {
            ...
            var a = this.mapSet;
            if (a) {
                var b = 1, c = a.getBBox(), d = this.realWidth, f = this.realHeight, g = c.width, c = c.height;
            ...
            if (a.description) {
                ...
                var c = a.descriptionWindowWidth, e = a.descriptionWindowHeight, f = a.descriptionWindowLeft,
            ...
            if (c) {
                ...
                for (f = 0; f < k; f++) {
                    g = c.childNodes[f];
                    var l = g.nodeName, m = g.nodeValue ? this.trim(g.nodeValue) : "", n = !1;
                    g.attributes && 0 < g.attributes.length && (n = !0);
                    if (0 !== g.childNodes.length || "" !== m || !1 !== n) if (3 ==
            ...
            for (var b = !1, c = "", e = 0; e < a.length; e++) {
                var f = a[e][0], g = a[e][1], h = d.degreesToRadians(a[e][0]), k = d.degreesToRadians(a[e][1]),
                    k = this.projectionFunction(h, k), h = d.roundTo(this.x2c(d.radiansToDegrees(k[0])), 3),
                    k = d.roundTo(this.y2c(d.radiansToDegrees(k[1])), 3);
                h < this.minMapXX && (this.minMapXX = h, this.leftLongLat = {longitude: f, latitude: g});
                h > this.maxMapXX && (this.maxMapXX = h, this.rightLongLat = {longitude: f, latitude: g});
                k < this.minMapYY && (this.minMapYY = k, this.topLongLat = {longitude: f, latitude: g});
                k > this.maxMapYY && (this.maxMapYY = k, this.bottomLongLat = {longitude: f, latitude: g});
                b ? c += " L " : (c += " M ", b = !0);
                c += h + " " + k
            }
            return c + " Z "
            ...
            var a = d.degreesToRadians(this.dataProvider.leftLongitude),
                ...
                e = d.degreesToRadians(this.dataProvider.bottomLatitude), f = a + (b - a) / 2, g = c + (e - c) / 2,
                h = this.dpProjectionFunction(f,
                    c)[1], k = this.dpProjectionFunction(f, e)[1], l = this.dpProjectionFunction(a, g)[0],
                m = this.dpProjectionFunction(b, g)[0], c = d.equirectangular(f, c), e = d.equirectangular(f, e),
                h = (c[1] - e[1]) / (h - k), a = d.equirectangular(a, g), b = d.equirectangular(b, g),
                l = (a[0] - b[0]) / (l - m);
            ...
            var a = d.degreesToRadians(this.dataProvider.leftLongitude),
                ...
                c = d.degreesToRadians(this.dataProvider.topLatitude),
                e = d.degreesToRadians(this.dataProvider.bottomLatitude), f = a + (b - a) / 2, g = c + (e - c) / 2,
                h = this.dpProjectionFunction(f, c)[1], k = this.dpProjectionFunction(f, e)[1],
                l = this.dpProjectionFunction(a,
                    g)[0], m = this.dpProjectionFunction(b, g)[0];
        ...
        stageXYToCoordinates: function (a, b) {
            ...
            if (g = c.invert) {
                var h = this.dataProvider.leftLongitude, k = this.dataProvider.rightLongitude,
            ...
            if (this.mapSet) {
                var e = this.dataProvider, f = e.bottomLatitude;
                c = e.topLatitude;
...
(function () {
    ...
    d.ZoomControl = d.Class({
        construct: function (a) {
            ...
            var f = c.buttonSize, g = c.zoomControlEnabled, h = c.panControlEnabled, k = c.buttonFillColor,
                ...
                q = c.gridHeight, y = c.zoomFactor, B = c.minZoomLevel, u = c.maxZoomLevel, w = c.buttonIconAlpha,
                v = c.buttonIconColor, A = c.roundButtons, C = a.svgIcons, x = a.getX(c.left), z = a.getY(c.top);
    ...
    d.SmallMap = d.Class({
        construct: function (a) {
            ...
            if (c.enabled) {
                ...
                e.push(f);
                c.buildSVGMap();
                var g = c.borderThickness, h = c.borderColor,
            ...
            var a = this.chart;
            if (a) {
                var b = a.zoomLevel(), c = this.width, d = this.height, f = c / (a.realWidth * b),
                    g = a.mapContainer.getBBox(), c = c / b, d = d / b, h = this.rectangle;
    ...
    d.AreasProcessor = d.Class({
        construct: function (a) {
            ...
            var a = this.chart, b = a.areasSettings, c = b.unlistedAreasColor, e = b.unlistedAreasAlpha,
                f = b.unlistedAreasOutlineColor, g = b.unlistedAreasOutlineAlpha, h = a.svgAreas, k = a.dataProvider,
                l = k.areas, m = {}, n;
            ...
            var g = e.color, h = e.alpha, k = e.outlineThickness, l = e.rollOverColor, m = e.selectedColor,
                ...
                w = e.bringForwardOnHover, v = e.preserveOriginalAttributes;
...
(function () {
    ...
    d.ImagesProcessor = d.Class({
        construct: function (a) {
            ...
            var c = this.chart, e = c.container, f = c.mapImagesContainer, g = c.stageImagesContainer,
                h = c.imagesSettings;
            a.remove && a.remove();
            var k = h.color, l = h.alpha, m = h.rollOverColor, n = h.rollOverOutlineColor, p = h.selectedColor,
                r = h.balloonText, t = h.outlineColor, q = h.outlineAlpha, y = h.outlineThickness, B = h.selectedScale,
                u = h.rollOverScale, w = h.selectable, v = h.labelPosition, A = h.labelColor, C = h.labelFontSize,
                x = h.bringForwardOnHover, z = h.labelRollOverColor, F = h.rollOverBrightness, E = h.selectedLabelColor;
            a.index = b;
            a.chart = c;
            ...
            var k = a.longitude, l = a.latitude, m = a.positionOnLine, h = a.imageLabel, n = this.chart.zoomLevel(), p,
                r;
            ...
            if (!isNaN(e) && !isNaN(f)) c.translate(e, f, NaN, !0); else if (!isNaN(l) && !isNaN(k)) if (f = b.coordinatesToXY(k, l), e = f.x, f = f.y, isNaN(p) || (e = p), isNaN(r) || (f = r), a.fixedSize) {
                p = a.positionScale;
...
(function () {
    ...
    d.LinesProcessor = d.Class({
        construct: function (a) {
            ...
            a.index = b;
            a.remove && a.remove();
            var c = this.chart, e = c.linesSettings, f = this.objectsToResize, g = c.mapLinesContainer,
                h = c.stageLinesContainer, k = e.thickness, l = e.dashLength, m = e.arrow, n = e.arrowSize,
                p = e.arrowColor, r = e.arrowAlpha, t = e.color, q = e.alpha, y = e.rollOverColor, B = e.selectedColor,
                u = e.rollOverAlpha, w = e.balloonText, v = e.bringForwardOnHover, A = e.arc, C = e.rollOverBrightness,
                x = c.container;
            a.chart = c;
            a.baseSettings = e;
            var z = x.set();
            ...
            if (a.remainVisible || c.selectedObject == a.parentObject) {
                ...
                if (0 < v.length) {
                    ...
                    a.fixedSize && q && (f = {
                        line: q,
                        thickness: F
                    }, this.linesToResize.push(f), a.arrays.push({arr: this.linesToResize, el: f}), f = {
                        line: l,
                        thickness: 5
                    }, this.linesToResize.push(f), a.arrays.push({arr: this.linesToResize, el: f}));
                    a.lineSvg = q;
...
(function () {
    ...
    d.parsePath = function (a) {
        ...
        for (var b = [], c = 0; c < a.length; c++) {
            var d = a[c].match(/([MmLlHhVvZz]{1})|([0-9.\-]+)/g), f = {letter: d[0]};
            switch (d[0]) {
                case "Z":
                case "Z":
                case "z":
    ...
    d.winkel3.invert = function (a, b) {
        var c = a, e = b, f = 25, g = Math.PI / 2;
        do var h = Math.cos(e), k = Math.sin(e),
            l = Math.sin(2 * e), m = k * k, n = h * h, p = Math.sin(c), r = Math.cos(c / 2), t = Math.sin(c / 2),
            q = t * t, y = 1 - n * r * r, B = y ? d.acos(h * r) * Math.sqrt(u = 1 / y) : u = 0, u,
            y = .5 * (2 * B * h * t + c / g) - a, w = .5 * (B * k + e) - b,
            v = .5 * u * (n * q + B * h * r * m) + .5 / g, A = u * (p * l / 4 - B * k * t),
            k = .125 * u * (l * t - B * k * n * p), m = .5 * u * (m * r + B * q * h) + .5, h = A * k - m * v,
            A = (w * A - y * m) / h, y = (y * k - w * v) / h, c = c - A,
    ...
    d.ValueLegend = d.Class({
        construct: function (a) {
            ...
            if (this.enabled) {
                ...
                var h = 0, k = this.minValue, l = this.fontSize, m = a.fontFamily, n = this.color, p = {
    ...
    d.ObjectList = d.Class({
        construct: function (a) {
            ...
            if (a.showInList && void 0 !==
                ...
                var g = a.titleTr;
                g || (g = a.title);
                var g = document.createTextNode(g), h = document.createElement("a");
